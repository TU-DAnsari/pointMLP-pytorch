...
class PointNetFeaturePropagation(nn.Module):
    def __init__(self, in_channel, out_channel, blocks=1, groups=1, res_expansion=1, bias=True, activation='relu'):
...
class PointMLPEncoder(nn.Module):
    ...
    def __init__(self, points=2048, input_dim=6, embed_dim=64, groups=1, res_expansion=1,
...
class PointMLPSegHead(nn.Module):
    ...
    def __init__(self, en_dims, gmp_dim, de_dims=[512, 256, 128, 128], de_blocks=[2, 2, 2, 2],
                 num_classes=2, groups=1, res_expansion=1, bias=True, activation="relu"):
...
class PointMLP(nn.Module):
    ...
    def __init__(self, num_classes=2, points=2048, input_dim=6, embed_dim=64, groups=1, res_expansion=1,
                 activation="relu", bias=True, use_xyz=True, normalize="anchor",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[4, 4, 4, 4],
...
def pointMLPSegmentation(num_classes=2, num_points=2048, **kwargs) -> PointMLP:
...
def pointMLPSegmentationSmall(num_classes=2, num_points=1024, input_dim=6, **kwargs) -> PointMLP:
    return PointMLP(num_classes=num_classes, 
                    points=num_points, 
                    input_dim=input_dim,
                    embed_dim=32, 
...
if __name__ == '__main__':
    ...
    model = pointMLPSegmentation(num_classes=2)
    out = model(data)
    print(out.shape)